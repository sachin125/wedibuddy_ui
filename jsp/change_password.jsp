...
<div class="col-xs-12 col-sm-12 col-md-12">
        <a href class="navbar-brand block m-t h1"><div class="h1">wedibuddy</div></a>
        <div class="m-b-lg">
            <div class="wrapper text-center Login_Sign" id="actionScenario">
            ...
            <form name="changePasswordLinkForm" autocomplete="off" class="form-validation" role="form" ng-submit="changePasswordLinkForm.$valid">
              <span ng-if="invalidData" class="text-danger"> 
	Both fields are mandatory. </span>
	 <span ng-if="notMatched && (newPasswordForm!=confirmpasswordForm)" class="text-danger"> 
	Fields do not match.</span>
                ...
                <button type="submit" ng-click="sendChangePassword()" class="btn btn-lg btn-primary btn-block">Change Password</button>
