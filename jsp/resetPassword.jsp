            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                ...
                <div class="m-b-lg">
                    <div class="wrapper text-center Login_Sign">
                        <strong class="h4">Please enter new password</strong>
                    </div>
                    <div class="text-danger wrapper text-center" ng-show="authError">
                    </div>
                    <div class="list-group list-group-sm Login_InputFrom">
                        <p id='reset_error' class="bigger-110 login-white red"></p>
                        <form id='htmlFormNew' name="htmlFormNew" action='j_security_pwd_update_check' method='post'>
                         ...
                         <form id="changePasswordLinkForm" name="changePasswordLinkForm" autocomplete="off" class="form-validation" role="form">
							<div class="list-group-item">
								<input autocomplete="off" id="newPasswordForm" ng-model="newPasswordForm" name="newPasswordForm" type="password" ng-focus="focusEventTriggered($event)" ng-blur="blurEventTriggered($event)" placeholder="New password" class="form-control no-border" ng-required="true" ng-change="validatePassword(newPasswordForm)" maxlength="15" />
							</div>
