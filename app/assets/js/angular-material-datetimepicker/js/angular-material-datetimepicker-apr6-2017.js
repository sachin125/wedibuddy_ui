(function (moment) {
  ...
  var template = '<md-dialog class="dtp" layout="column" style="width: 300px;">'
    ...
    + '                <div class="dtp-actual-day" ng-if="picker.dateMode">{{picker.currentDate.format("dddd")}}</div>'
    ...
    + '                <div class="dtp-picker-datetime" ng-if="picker.currentView !== picker.VIEWS.DATE">'
    ...
    + '                        </div>'
    + '                        <div ng-if="!picker.timeMode" class="dtp-actual-time p60">{{picker.currentNearest5Minute().format(picker.params.shortTime ? "hh:mm" : "HH:mm")}}</div>'
    + '                        <div class="right p20">'
